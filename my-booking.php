...
<li>
                ...
                <div class="vehicle_title">
                  ...
                  Upload receipt of deposit payment :<br/>
<form action="upload_booking.php" method="post" enctype="multipart/form-data">
<label for="file">Filename:</label>
<input type="file" name="file" id="file"><br>

<input type="hidden" name="id_paid" value="<?php echo htmlentities($result->idbook); ?>" />
