...
if($lastInsertId)
{
$msg="Thank You For Contact Us. We will contact you shortly";
}
else 
{
...
<title>Car-On-The-GO - Responsive Car Dealer HTML5 Template</title>
<!--Bootstrap -->
    ...
    <div  class="row">
      <div class="col-md-6">
        <h3>Get in touch using the form below</h3>
          <?php if($error){?>
          <div class="errorWrap"><?php echo htmlentities($error); ?> </div><?php } 
        else if($msg){?>
